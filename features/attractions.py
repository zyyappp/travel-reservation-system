...
def reserve_attraction(user_id):
    ...
    city_attractions = apply_filter(attraction_data, account["city"], user_filter)
    ...
    while current_page != "finished":
        ...
        if current_page == "attractions_search":
            ...
            browse_selection = ["Browse attractions", "Change filters", "Reset filters", "Back"]
        ...
        if current_page == "change_filters":
            ...
            new_filter = select("Sort by:", filter_choices + ["Back"])
            ...
            if new_filter == "BACK" or new_filter == "Back":
                ...
                select_category = select("", attraction_data[attraction_data["City"] == account["city"]]["Category"].drop_duplicates())
        ...
        if current_page == "attractions_selection":
            print_header(f"ATTRACTIONS IN {account["city"].upper()}")
